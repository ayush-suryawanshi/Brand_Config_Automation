...
while True:
    ...
    for attachment in attachments:
        ...
        context_data = read_file_data(BASE_DIR/"engine_brain"/"realme_explainer.txt")
        sparcs_fields = read_file_data(BASE_DIR/"engine_brain"/"realme_sparcs_fields.txt")
        sample_scheme_chunck = read_file_data(BASE_DIR/"engine_brain"/"realme_sample_scheme_chunck.txt")
                ...
                for sheet_name in sheet_list:
                    ...
                    for row in df:
                        try:
                            ...
                            new_row = Input_Row.objects.create(brand='Realme',jsonified_row_data = input_data)
