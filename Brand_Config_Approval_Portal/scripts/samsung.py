...
while True:
    ...
    for attachment in attachments:
        ...
        context_data = read_file_data(BASE_DIR/"engine_brain"/"samsung_explainer.txt")
        sparcs_fields = read_file_data(BASE_DIR/"engine_brain"/"samsung_sparcs_fields.txt")
        sample_scheme_chunck = read_file_data(BASE_DIR/"engine_brain"/"samsung_sample_scheme_chunck.txt")
                ...
                for sheet_name in sheet_list:
                    ...
                    for row in df:
                        try:
                            ...
                            new_row = Input_Row.objects.create(brand='Samsung',jsonified_row_data = input_data)
